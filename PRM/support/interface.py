...
def check_obstacles_and_qstart(Cobs,pos_node_start,pos_dim,mux,is_qstart):
	x,y,lx,ly = pos_dim
	start_init = False
	...
	if mux == 1 and pygame.mouse.get_pressed()[0] == True: # left click
		...
		mux = 1
	pos_dim = x,y,lx,ly
	return Cobs,pos_node_start,pos_dim,mux,is_qstart,start_init


def draw_obstacles_and_qstart(screen,Cobs,pos_dim,mux,is_qstart):
	x,y,lx,ly = pos_dim
	if mux == 0:
		x2,y2 = pygame.mouse.get_pos()
		lx, ly = x2 - x, y2 - y
